...
class MemberServiceImplTest {
    ...
    void testAddMember() throws SQLException {
        MemberDTO newMember = new MemberDTO(1, "John", "Doe", "john.doe@example.com", Role.DEVELOPER, 1);
    ...
    void testUpdateMember() throws SQLException {
        MemberDTO newMember = new MemberDTO(1, "Jane", "Smith", "jane.smith@example.com", Role.DESIGNER, 1);
        Member addedMember = memberService.addMember(newMember);

        MemberDTO updatedMemberDTO = new MemberDTO(addedMember.getId(), "Jane", "Doe", "jane.doe@example.com", Role.PROJECT_MANAGER, 1);
    ...
    void testDeleteMember() throws SQLException {
        MemberDTO newMember = new MemberDTO(1, "Mark", "Taylor", "mark.taylor@example.com", Role.DESIGNER, 1);
        Member addedMember = memberService.addMember(newMember);
    ...
    void testGetAllMembers() throws SQLException {
        MemberDTO newMember = new MemberDTO(1, "Alice", "Johnson", "alice.johnson@example.com", Role.DESIGNER, 1);
    ...
    void testSearchMembers() throws SQLException {
        MemberDTO newMember = new MemberDTO(1, "Bob", "Brown", "bob.brown@example.com", Role.DEVELOPER, 1);
        memberService.addMember(newMember);
    ...
    void testGetTotalMemberCount() throws SQLException {
        MemberDTO newMember = new MemberDTO(1, "Emma", "Wilson", "emma.wilson@example.com", Role.PROJECT_MANAGER, 1);
        memberService.addMember(newMember);
